...
- [ ] **Phase 269: Install Identity + Opt-Out Scaffold** -- per-install UUIDv4 in `chrome.storage.local`; opt-out kill switch in Advanced Settings.
...
|-------|----------------|--------|-----------|
| 269. Install Identity + Opt-Out Scaffold | 0/TBD | Not started | - |
