...
No active milestone is open. `v0.9.36 MCP Visual Lifecycle & Client Identity` shipped on 2026-04-24.

Run `$gsd-new-milestone` to define the next milestone and recreate `.planning/REQUIREMENTS.md` for the new scope.
