...
Between milestones. v0.9.47 (Workspace Reorganization) shipped 2026-05-02. Next milestone TBD; **Angular 19 → 20 migration is the leading candidate** (deadline 2026-05-19).
...
_None active — define the next milestone with `/gsd-new-milestone` (Angular 19 → 20 migration is the leading candidate; deadline 2026-05-19)._
