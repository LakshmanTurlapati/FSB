...
- [ ] **Phase 161: Module Adoption** - Migrate consumers to use extracted class instances (createSession, CostTracker, TurnResult, ActionHistory, session.mode)
- [ ] **Phase 162: Event Bus Wiring** - Connect SessionStateEmitter to UI consumers so progress events reach popup/sidepanel (completed 2026-04-02)
...
**Plans:** 3 plans
Plans:
- [ ] 161-01-PLAN.md -- createSession adoption at 3 background.js construction sites + mode routing + mode field in SESSION_FIELDS
- [ ] 161-02-PLAN.md -- CostTracker, ActionHistory, and TurnResult wiring in agent-loop.js
- [ ] 161-03-PLAN.md -- Gap closure: add mode field to persistableSession in persistSession() (ADOPT-05)
...
| 161. Module Adoption | 0/3 | Not started | - |
| 162. Event Bus Wiring | 0/? | Not started | - |
