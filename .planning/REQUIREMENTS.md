...
- [ ] **PROMPT-01**: System prompt groups tools by interaction type (DOM element, CDP coordinate, text range, file upload) with "when to use which" decision guidance
- [ ] **PROMPT-02**: Task-type detection triggers tool-specific prompt sections -- canvas/map tasks prioritize CDP tools, form tasks prioritize DOM tools, text tasks prioritize selection tools
...
| PROMPT-01 | Phase 98 | Pending |
| PROMPT-02 | Phase 98 | Pending |
