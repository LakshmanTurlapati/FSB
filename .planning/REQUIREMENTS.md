...
- [ ] **CONTRACT-01**: The set of MCP action tools is enumerated and frozen for this milestone in a canonical list (committed to `.planning/v0.9.62-ACTION-TOOLS.md` or equivalent). At minimum the list includes: `click`, `type_text`, `navigate`, `scroll`, `drag`, `select_option`, `press_key`, `press_enter`, `drag_drop`, `hover`, `focus`, `clear_input`, `check_box`, `drop_file`, `click_and_hold`, `double_click`, `right_click`, `click_at`, `scroll_at`, `double_click_at`, `drag_variable_speed`, `set_attribute`, `insert_text`, `search`, `refresh`, `go_back`, `go_forward`, `open_tab`, `close_tab`, `switch_tab`, `back`.
...
- [ ] **CONTRACT-05**: Read-only MCP tools (`get_text`, `read_page`, `list_tabs`, `get_dom_snapshot`, `get_page_snapshot`, `get_attribute`, `get_logs`, `get_task_status`, `search_memory`, `wait_for_element`, `wait_for_stable`, etc.) do not carry the new fields; their input schemas remain byte-for-byte unchanged.
