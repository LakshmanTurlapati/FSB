...
- [x] **Phase 260: Skill Docs Migration** -- Update `skills/FSB Skill/USAGE.md`, `references/visual-session-lifecycle.md`, `references/tool-decision-tree.md`, and the SKILL.md body so callers see the new contract on the surfaces they read first; canonical action-tool list referenced. (completed 2026-05-11)
...
| 260. Skill Docs Migration | 1/1 | Complete    | 2026-05-11 |
