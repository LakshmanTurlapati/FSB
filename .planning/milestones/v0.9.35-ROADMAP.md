...
Plans:
- [x] 201-01-PLAN.md -- Add executable installer parity and setup-guidance contract tests
- [x] 201-02-PLAN.md -- Resolve host path/config variants and make the installer matrix green
- [x] 201-03-PLAN.md -- Ship host-specific activation guidance and manual fallback docs
...
Plans:
- [x] 202-01-PLAN.md -- Add a lifecycle smoke harness for restart, wake, and relay recovery
- [x] 202-02-PLAN.md -- Add MCP tool smoke coverage for the core browser/autopilot/observability slice
- [x] 202-03-PLAN.md -- Capture dated cross-host UAT evidence and release smoke guidance
...
| 201. Platform Installer & Config Parity | 3/3 | Complete   | 2026-04-24 |
| 202. Cross-Host Smoke Matrix & Release Hardening | 3/3 | Complete   | 2026-04-24 |
